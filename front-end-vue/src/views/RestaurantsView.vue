  ...
  <section>
    ...
    <article class="panel is-info">
      ...
      <div class="panel-block">
        <label class="checkbox"><input type="checkbox" /> Maki | 89.2zł</label>
      </div>
      <div class="panel-block">
        <label class="checkbox"
          ><input type="checkbox" /> Philadelphia Roll | 122zł</label
        >
      </div>
      <div class="panel-block">
        <label class="checkbox"
          ><input type="checkbox" /> Volcano Roll | 22.5zł</label
        >
      </div>
    </article>
    <div class="box">
