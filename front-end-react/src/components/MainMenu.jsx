...
export function MainMenu() {
  ...
  const {
    ...
    error: ordersError,
    data: orders,
  } = useQuery(["orders"], ordersResource.getAll);

  return (
    <aside>
      <p className="menu-label">Restaurants</p>
      <ul className="menu-list">
        {isLoading && <Notification message="Loading..." />}
        {isError && <Notification type="danger" message={error.message} />}
        {restaurants &&
      ...
      <ul className="menu-list">
        {isOrdersLoading && <Notification message="Loading..." />}
        {ordersError && (
